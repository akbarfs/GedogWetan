...
@endsection
          ...
          @if ($JumlahDatapengumuman>0)
            <div class="alert alert-success">Ditemukan {{ $JumlahDatapengumuman}} data dengan kata kunci : {{$cari}}</div>
                  ...
                  <div class="alert alert-danger">Data dengan kata kunci : {{$cari}} Tidak Ditemukan
                      <a href="{{url('/pengumuman')}}"><input type="button" class="btn btn-danger" value="Klik Disini untuk kembali"></a>
                  </div>
                  @endif
            </div>
        </div>
