                ...
                @endif
                  ...
                  @endphp
                    <tr>
                      ...
                      <td align="center">
                        <form action="{{url('/berita.'.$Berita->id_berita)}}" method="Post" onsubmit="return confirm('Apakah data ingin dihapus?')">
                        @csrf
                        <a href="{{url('/berita.'.$Berita->id_berita.'.detail')}}" class="btn btn-xs btn-info" title="Detail"><i class="nc-icon nc-badge"></i></a>
                        <a href="{{url('/berita.'.$Berita->id_berita.'.edit')}}" class="btn btn-xs btn-info" title="Edit"><i class="nc-icon nc-settings-gear-65"></i></a>
