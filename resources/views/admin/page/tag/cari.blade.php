...
@endsection
          ...
          @if ($JumlahDataTag>0)
                  <div class="alert alert-success">Ditemukan {{ $JumlahDataTag}} data dengan kata kunci : {{$cari}}</div>
                  ...
                  <div class="alert alert-danger">Data dengan kata kunci : {{$cari}} Tidak Ditemukan
                      <a href="{{url('/kategori')}}"><input type="button" class="btn btn-danger" value="Klik Disini untuk kembali"></a>
                  </div>
                  @endif
